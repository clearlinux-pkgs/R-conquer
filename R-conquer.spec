...
Version  : 1.2.0
Release  : 11
URL      : https://cran.r-project.org/src/contrib/conquer_1.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/conquer_1.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635642258
