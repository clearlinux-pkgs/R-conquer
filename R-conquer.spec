...
Version  : 1.0.1
Release  : 1
URL      : https://cran.r-project.org/src/contrib/conquer_1.0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/conquer_1.0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595345997
